...
const soundData = [
  ...
  { "id": "2", "name": "Tent", "icon": "bug-outline" },
  { "id": "3", "name": "Rain", "icon": "bug-outline" },
  { "id": "4", "name": "Clock", "icon": "alarm-outline" },
  { "id": "5", "name": "White Noise", "icon": "volume-high-outline" },
  { "id": "6", "name": "Leaves", "icon": "leaf-outline" },
  { "id": "7", "name": "Ocean Waves", "icon": "water-outline" },
