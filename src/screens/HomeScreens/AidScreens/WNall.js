...
import MultiSoundPlayer from "../../Player/MultiSoundPlayer";

const soundData = [
  { id: "1", name: "Keyboard", icon: "bug-outline" },
  { id: "2", name: "Clock", icon: "grid-outline" },
  { id: "3", name: "Birds", icon: "flame-outline" },
...
// Map sound names to Firebase Storage paths (update as needed)
...
const WNall = () => {
  ...
  const addSoundToPlayer = (item, uri) => {
